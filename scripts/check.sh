...
if grep -nE '\(this[,)]|\[this[,]' app/grid-layout.js app/desktop-monitor.js app/dbus-remote-operations.js app/selection-manager.js app/search-dialog.js app/keyboard-manager.js; then
