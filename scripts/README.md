...
| `refresh_extension.sh` | 开发热刷新：重建 + 重装 + 杀掉运行中的 DING 进程 | `bash scripts/refresh_extension.sh` |
| `export-zip.sh` | 打包 `desktop-icons-ng@icookie-tea.github.io.zip` 用于 extensions.gnome.org | `bash scripts/export-zip.sh` |
