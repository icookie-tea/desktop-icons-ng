...
> 本文为 `docs/fixes.md` 的历史归档（2026-08 条目）。新条目请写入 `docs/fixes.md`。
> 2026-07 及更早条目见 [fixes-2026-07.md](fixes-2026-07.md)；可维护性重构总览见 [maintainability-refactor.md](maintainability-refactor.md)。
...
> 重构总览见 [maintainability-refactor.md](maintainability-refactor.md)，以下为其中各修复的完整记录。
