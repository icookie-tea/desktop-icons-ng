...
export function preferencesFrame(_Gtk, desktopSettings, nautilusSettings, gtkSettings) {
    ...
    desktopGroup.add(buildSwitcher(desktopSettings, 'accent-shade-follow-color-scheme', _('Follow the color scheme for the accent shade'), _('Use a darker shade in light mode and a brighter shade in dark mode, like Nautilus. Disabled by default: the brighter shade is always used, because the desktop wallpaper does not change with the color scheme.')));
